...
import dev.throwouterror.game.common.Entity;
import dev.throwouterror.game.object.Material;
...
public class Renderer {
    ...
    //Send uniform data
    protected void sendUniforms(Entity entity, Model entityModel) {
...
/*        // Get the matrices
        ...
        Material material = entityModel.getMaterial();
    ...
    public void renderEntity(Entity entity, Model model) {

        //Send the uniform variables to the shader
        sendUniforms(entity, model);
